<template>
  <v-expansion-panel>
    ...
    <v-expansion-panel-content>
      <v-row>
        <v-col>
          <v-select v-model="animType" :items="options" :label="translate('registry.alerts.animationIn.type')">
          ...
          <v-text-field v-model.number="animDuration" type="number" min="100" :label="translate('registry.alerts.animationIn.duration')" />
        </v-col>
