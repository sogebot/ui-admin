      ...
      <v-card outlined class="pt-3">
        <v-card-text>
          <v-form ref="form" v-model="valid" lazy-validation>
            ...
            <v-row dense>
              <v-col>
                <v-combobox v-model="item.group" :label="translate('group')" hide-details="auto" clearable
                  :search-input.sync="item.groupToBeShownInTable" :return-object="false"
            ...
            <draggable v-model="item.responses" draggable=".item" handle=".handle">
              <v-list-item v-for="(r, i) of item.responses" :key="'response' + i" class="item">
                <v-list-item-content>
...
const newItem: KeywordInterface = {
  group:     null,
  keyword:   '',
  responses: [],
  enabled:   true,
